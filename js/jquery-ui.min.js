...
!(function (t) {
  ...
  (p = t.cleanData),
    ...
    (t.widget.extend = function (e) {
      for (var i, s, a = o.call(arguments, 1), r = 0, l = a.length; r < l; r++)
        for (i in a[r])
          (s = a[r][i]),
            n.call(a[r], i) &&
              void 0 !== s &&
      ...
      option: function (e, i) {
        ...
        if ("string" == typeof e) {
          if (((a = {}), (e = (s = e.split(".")).shift()), s.length)) {
            for (
              o = 0, n = a[e] = t.widget.extend({}, this.options[e]);
              o < s.length - 1;
              o++
            )
              (n[s[o]] = n[s[o]] || {}), (n = n[s[o]]);
      ...
      (t.position = {
        ...
        (t.fn.position = function (e) {
          ...
          return (
            (v =
              9 === (l = b[0]).nodeType
                ...
                ? {
                    width: 0,
                    height: 0,
                    offset: { top: l.pageY, left: l.pageX },
                  }
                : {
                    width: b.outerWidth(),
            ...
            "right" === e.at[0]
              ? (_.left += f)
              : "center" === e.at[0] && (_.left += f / 2),
            "bottom" === e.at[1]
              ? (_.top += g)
              : "center" === e.at[1] && (_.top += g / 2),
            (p = c(k.at, f, g)),
            (_.left += p[0]),
            (_.top += p[1]),
            this.each(function () {
        ...
        (t.ui.position = {
          fit: {
            left: function (t, e) {
              ...
              e.collisionWidth > a
                ? l > 0 && h <= 0
                  ? ((s = t.left + l + e.collisionWidth - a - o),
                    (t.left += l - s))
                  : h > 0 && l <= 0
                  ? (t.left = o)
                  : l > h
            ...
            top: function (t, e) {
              ...
              e.collisionHeight > a
                ? l > 0 && h <= 0
                  ? ((s = t.top + l + e.collisionHeight - a - o),
                    (t.top += l - s))
                  : h > 0 && l <= 0
                  ? (t.top = o)
                  : l > h
  ...
  t(document).on("mouseup", function () {
      ...
      switch (i) {
        ...
        case "pointer":
          return (
            ...
            n >= p &&
              n < p + o &&
              ((a = s.pageX), (r = e.proportions().width), a >= d && a < d + r)
          );
        case "touch":
          return (
    ...
    t.widget("ui.resizable", t.ui.mouse, {
      ...
      _hasScroll: function (e, i) {
        ...
        if (
          "scroll" === o ||
          e[(s = i && "left" === i ? "scrollLeft" : "scrollTop")] > 0
        )
          return !0;
        try {
          (e[s] = 1), (n = e[s] > 0), (e[s] = 0);
      ...
      _calculateAdjustedElementDimensions: function (t) {
        ...
        return "content-box" === t.css("box-sizing") &&
          ...
          ? ((e = parseFloat(n.style.width)),
            ...
            {
              height: (i = isNaN(i)
                ? this._getElementTheoreticalSize(t, s, "height")
                : i),
              width: e,
            })
          : {
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                "touch" === n.tolerance
                  ...
                  : "fit" === n.tolerance &&
                    (h =
                      c.left > o && c.right < r && c.top > a && c.bottom < l),
                h
                  ? (i.selected &&
    ...
    t.widget("ui.sortable", t.ui.mouse, {
      ...
      _mouseStart: function (e, i, s) {
        ...
        if (
          ...
          this.refreshPositions(),
          (this.appendTo = t(
            "parent" !== a.appendTo ? a.appendTo : this.currentItem.parent()
          )),
    ...
    t.widget("ui.autocomplete", {
      ...
      _create: function () {
        var e,
          ...
          a = "input" === n;
        (this.isMultiLine =
          o || (!a && "true" === this.element.prop("contentEditable"))),
  ...
  t.widget("ui.controlgroup", {
    ...
    _resolveClassesValues: function (e, i) {
      ...
      return (
        t.each(e, function (t) {
          ...
          (n = String.prototype.trim.call(n.replace(r, ""))),
          ...
          return (
            i
              ? this.length || "instance" !== e
                ...
                : (n = void 0)
              : (s.length && (e = t.widget.extend.apply(null, [e].concat(s))),
                this.each(function () {
                  var i = t(this).attr("type"),
                    s =
                      "checkbox" !== i && "radio" !== i
                        ...
                        : "checkboxradio",
                    n = t.data(this, "ui-" + s);
                  if (n) n.option(e || {}), n._init && n._init();
                  else {
                    if ("button" === s) {
                      m.call(t(this), e);
                      return;
    ...
    t.ui.button,
    t.extend(t.ui, { datepicker: { version: "1.14.1" } }),
    t.extend(l.prototype, {
      ...
      _findPos: function (e) {
        ...
        while (
          e &&
          ("hidden" === e.type || 1 !== e.nodeType || t.expr.pseudos.hidden(e))
        )
      ...
      _generateHTML: function (e) {
        ...
        if ((tt < 0 && ((tt += 12), te--), Z)) {
          (i = this._daylightSavingAdjust(
            new Date(
              Z.getFullYear(),
              Z.getMonth() - V[0] * V[1] + 1,
              Z.getDate()
            )
          )),
            (i = J && i < J ? J : i);
          while (this._daylightSavingAdjust(new Date(te, tt, 1)) > i)
            --tt < 0 && ((tt = 11), te--);
        }
        for (
          e.drawMonth = tt,
          ...
          for (D = 0, C = "", this.maxRows = 4; D < V[1]; D++) {
            ...
            for (
              P += M + "</tr></thead><tbody>",
                ...
                O = Math.ceil(
                  ((z = (this._getFirstDayOfMonth(te, tt) - u + 7) % 7) + H) / 7
                ),
      ...
      _generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
        var l,
          ...
          x = "";
        if (o || !m)
          x += "<span class='ui-datepicker-month'>" + a[e] + "</span>";
        else {
          for (
            l = s && s.getFullYear() === i,
              h = n && n.getFullYear() === i,
              ...
              this.document.on(
                ...
                function (t) {
                  if (!e) {
                    ...
                    i._allowInteraction(t) ||
                      (t.preventDefault(), i._focusTabbable());
                  }
                }.bind(this)
              ),
    ...
    t.widget("ui.slider", t.ui.mouse, {
      ...
      values: function (t, e) {
        ...
        for (
          n = 0, i = this.options.values, s = arguments[0];
          n < i.length;
          n += 1
        )
      ...
      _processTabs: function () {
        ...
        (this.tablist = this._getList().attr("role", "tablist")),
          ...
          this.anchors.each(function (i, s) {
            ...
            e._isLocal(s)
              ? ((a = (n = decodeURIComponent(s.hash)).substring(1)),
                (o = e.element.find("#" + CSS.escape(a))))
              : ((n =
                  "#" +
  ...
  function S(e) {
    ...
    T(k, function (t, n) {
      ...
      if (r)
        return (
          (o = i[l](r)),
          (i[D[l].cache] = o[D[l].cache]),
          (s = i._rgba = o._rgba),
          !1
        );
    }),
    s.length)
      ? ("0,0,0,0" === s.join() && t.extend(s, b.transparent), i)
      : b[e];
  }
  function H(t, e, i) {
    return 6 * (i = (i + 1) % 1) < 1
  ...
  T(D, function (t, e) {
    ...
    (C.fn = t.extend(C.prototype, {
      parse: function (e, i, s, n) {
        ...
        var o = this,
          a = P(e),
          r = (this._rgba = []);
        return (void 0 !== i && ((e = [e, i, s, n]), (a = "array")),
        "string" === a)
          ? this.parse(S(e) || b._default)
          : "array" === a
          ? (T(D.rgba.props, function (t, i) {
              r[i.idx] = M(e[i.idx], i);
            }),
            this)
          : "object" === a
    ...
    (D.hsla.from = function (t) {
      ...
      var e = t[0] / 360,
        ...
        a = 2 * s - o;
      return [
        Math.round(255 * H(a, o, e + 1 / 3)),
        Math.round(255 * H(a, o, e)),
        Math.round(255 * H(a, o, e - 1 / 3)),
        n,
      ];
    }),
    T(D, function (t, e) {
      var i = e.props,
        ...
        o = e.from;
      (C.fn[t] = function (t) {
        if ((n && !this[s] && (this[s] = n(this._rgba)), void 0 === t))
          return this[s].slice();
        var e,
          a = P(t),
        ...
        return (T(i, function (t, e) {
          ...
          null == i && (i = l[e.idx]), (l[e.idx] = M(i, e));
        }),
        o)
          ? (((e = C(o(l)))[s] = l), e)
          : C(l);
        ...
        T(i, function (e, i) {
          !C.fn[e] &&
            (C.fn[e] = function (s) {
              ...
              "undefined" === l)
                ? o
                : ("function" === l && (l = P((s = s.call(this, o)))),
                  null == s && i.empty)
                ? this
                : ("string" === l &&
                    (a = x.exec(s)) &&
    ...
    (C.hook = function (e) {
      T(e.split(" "), function (e, i) {
        (t.cssHooks[i] = {
          set: function (t, e) {
            var s;
            "transparent" !== e &&
              ("string" !== P(e) || (s = S(e))) &&
              (e = (e = C(s || e)).toRgbaString()),
              (t.style[i] = e);
          },
        }),
    ...
    (t.cssHooks.borderColor = {
      expand: function (t) {
        var e = {};
        return (
          T(["Top", "Right", "Bottom", "Left"], function (i, s) {
            e["border" + s + "Color"] = t;
          }),
          e
        );
          ...
          t.extend(t.effects, {
            save: function (t, e) {
              for (var i = 0, s = e.length; i < s; i++)
                null !== e[i] && t.data(z + e[i], t[0].style[e[i]]);
            },
            restore: function (t, e) {
              for (var i, s = 0, n = e.length; s < n; s++)
                null !== e[s] && ((i = t.data(z + e[s])), t.css(e[s], i));
            },
    ...
    t.extend(e, {
      ...
      Elastic: function (t) {
        return 0 === t || 1 === t
          ? t
          : -Math.pow(2, 8 * (t - 1)) *
              Math.sin((((t - 1) * 80 - 7.5) * Math.PI) / 15);
      },
      Back: function (t) {
        return t * t * (3 * t - 2);
      },
  ...
  t.effects.define("blind", "hide", function (e, i) {
    ...
    t.effects.define("explode", "hide", function (e, i) {
      ...
      function m() {
        g.push(this),
          g.length === h * h &&
            (c.css({ visibility: "visible" }), t(g).remove(), i());
      }
      for (s = 0; s < h; s++)
    ...
    t.effects.define("fold", "hide", function (e, i) {
      ...
      a && (o = (parseInt(a[1], 10) / 100) * p[+("hide" !== n)]),
        ...
        (d.clip[r[1]] = 0),
        "show" === n &&
          (s.cssClip(d.clip), h && h.css(t.effects.clipToBox(d)), (d.clip = c)),
        s
          .queue(function (i) {
            h &&
              h
    ...
    t.effects.define("scale", function (e, i) {
      var s = t(this),
        ...
        o =
          ...
          (0 === parseInt(e.percent, 10) ? 0 : 100 * ("effect" === n)),
        a = t.extend(
          !0,
          {
    ...
    t.effects.define("pulsate", "show", function (e, i) {
      ...
      s.animate({ opacity: l }, r, e.easing),
        s.queue(i),
        t.effects.unshift(s, c, a + 1);
    }),
